...
struct UAIShipDebugFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void RequestAIShipForCrew(struct UObject* WorldContextObject, struct FGuid CrewId); // Function AIShips.AIShipDebugFunctionLibrary.RequestAIShipForCrew // Final|Native|Static|Public|HasDefaults|BlueprintCallable // @ game+0x41b3ad0
	struct FAIShipEncounterBattleDesc GenerateAIShipBattleDesc(struct UObject* WorldContextObject, struct UAIShipServiceDataAsset* ServiceParams); // Function AIShips.AIShipDebugFunctionLibrary.GenerateAIShipBattleDesc // Final|Native|Static|Public|BlueprintCallable // @ game+0x41b3980
};
...
struct AAthenaAIShipController : AAthenaAIControllerBase {
	...
	void ApplyControllerParams(struct UAthenaAIControllerParamsDataAsset* ParamsAsset, struct APawn* InPawn); // Function AIShips.AthenaAIShipController.ApplyControllerParams // Native|Public|BlueprintCallable // @ game+0x41b38b0
};
...
struct UCursedCrewCustomisationInterface : UInterface {
	...
	void SetCursedCrewCustomisationProperties(struct FAIShipSailData SailData); // Function AIShips.CursedCrewCustomisationInterface.SetCursedCrewCustomisationProperties // Native|Event|Public|HasOutParms|BlueprintEvent // @ game+0x41b3b90
};
