...
struct UOceanCrawlerAnimationInstance : UAnimInstance {
	...
	void ClearActiveAttack(); // Function OceanCrawlersAnimation.OceanCrawlerAnimationInstance.ClearActiveAttack // Final|Native|Public|BlueprintCallable // @ game+0x154f1a0
	void BeginNewAttack(); // Function OceanCrawlersAnimation.OceanCrawlerAnimationInstance.BeginNewAttack // Final|Native|Public|BlueprintCallable // @ game+0x154f180
};
