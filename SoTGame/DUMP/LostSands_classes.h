...
struct ALostSandsRowboatGunpowderBarrel : AActor {
	...
	bool IsFuseEnabled(); // Function LostSands.LostSandsRowboatGunpowderBarrel.IsFuseEnabled // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4882d50
	bool IsExplosionAtGoldenSandsOutpost(struct FVector InLocation); // Function LostSands.LostSandsRowboatGunpowderBarrel.IsExplosionAtGoldenSandsOutpost // Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x4882cb0
	void EnableFuse(); // Function LostSands.LostSandsRowboatGunpowderBarrel.EnableFuse // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x4882c90
	void DisableFuse(); // Function LostSands.LostSandsRowboatGunpowderBarrel.DisableFuse // Final|RequiredAPI|Native|Public|BlueprintCallable // @ game+0x4882c70
};
