...
struct UWwiseEvent : UObject {
	...
	bool IsAudible(struct FVector SoundPosition, struct FVector ListenerPos, float AttenuationScaler); // Function WwiseAudio.WwiseEvent.IsAudible // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const // @ game+0x53991a0
	float GetMaxAttenuation(); // Function WwiseAudio.WwiseEvent.GetMaxAttenuation // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5399170
	char GetDurationType(); // Function WwiseAudio.WwiseEvent.GetDurationType // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5399130
	float GetDurationMin(); // Function WwiseAudio.WwiseEvent.GetDurationMin // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x5399100
	float GetDurationMax(); // Function WwiseAudio.WwiseEvent.GetDurationMax // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x53990d0
};
