...
struct APetAIController : AAthenaAIController {
	...
	void OnPerceptionUpdated(struct TArray<struct AActor*> ChangedPerceivedActors); // Function Pets.PetAIController.OnPerceptionUpdated // Native|Public // @ game+0x44f8f30
	struct UAthenaAICharacterPathFollowingComponent* GetAthenaAICharPathFollowingComp(); // Function Pets.PetAIController.GetAthenaAICharPathFollowingComp // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x44f8e20
};
...
struct UPetHangoutSpotComponent : USceneComponent {
	...
	void OnRep_IsOwnerSinking(); // Function Pets.PetHangoutSpotComponent.OnRep_IsOwnerSinking // Final|Native|Private // @ game+0x44f90f0
};
...
struct APetItemInfo : ANonStorableItemInfo {
	...
	void OnRep_PetOwner(); // Function Pets.PetItemInfo.OnRep_PetOwner // Final|Native|Private // @ game+0x44f91b0
};
...
struct UPetOwnerComponent : UActorComponent {
	...
	void Server_RequestDismissal(); // Function Pets.PetOwnerComponent.Server_RequestDismissal // Net|NetReliableNative|Event|Public|NetServer|NetValidate // @ game+0x44f9340
};
...
struct UPetsService : UObject {
	...
	void RemovePetFromActor(struct AActor* InOwner); // Function Pets.PetsService.RemovePetFromActor // Final|Native|Public|BlueprintCallable // @ game+0x44f92b0
	void AddPetForActorAndWield(struct UClass* InPetType, struct FPetCustomisation InCustomisation, struct AActor* InOwner, bool IsWielded); // Function Pets.PetsService.AddPetForActorAndWield // Native|Public|BlueprintCallable // @ game+0x44f8c80
	void AddPetForActor(struct UClass* InPetType, struct FPetCustomisation InCustomisation, struct AActor* InOwner); // Function Pets.PetsService.AddPetForActor // Final|Native|Public|BlueprintCallable // @ game+0x44f8b10
};
...
struct AWieldablePet : ASkeletalMeshWieldableItem {
	...
	void OnRep_HungerReactAnimationState(); // Function Pets.WieldablePet.OnRep_HungerReactAnimationState // Final|Native|Private // @ game+0x44f90b0
	void OnRep_DropRequest(char PriorDropRequest); // Function Pets.WieldablePet.OnRep_DropRequest // Final|Native|Private // @ game+0x44f9030
};
