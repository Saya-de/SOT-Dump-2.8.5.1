...
struct AEmoteDice : AActor {
	...
	void SetDiceMesh(char DiceType); // Function EmotingFramework.EmoteDice.SetDiceMesh // Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x188c2f0
	void SendTelemetryData(struct FTransform OrientationUsed, int32_t RollNumber, char DiceType); // Function EmotingFramework.EmoteDice.SendTelemetryData // Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x35f5bf0
	void RollDice(int32_t RollNumber, char DiceType); // Function EmotingFramework.EmoteDice.RollDice // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x35f5b20
};
