...
struct UTaleQuestSelectTradeRouteStepDesc : UTaleQuestStepDesc {
	struct FTradeRouteMappingFilterQuestVariable TradeRouteMappingFilter; // 0x80(0x30)
	int32_t NumSelectFromClosestIslands; // 0xb0(0x04)
	char UnknownData_B4[0x4]; // 0xb4(0x04)
	struct FQuestVariableVector SelectionOriginPointVar; // 0xb8(0x30)
	struct FQuestVariableInt TradeRouteDifficulty; // 0xe8(0x30)
	struct FQuestVariableTradeRouteData TradeRoute; // 0x118(0x30)
	struct FQuestVariableTaleResourceHandle AllocatedTradeRouteHandleVar; // 0x148(0x30)
};
