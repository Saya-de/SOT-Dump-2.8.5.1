...
struct UStoryDrivenBlendedLightingZoneComponent : UBlendedLightingZoneComponent {
	...
	void OnRep_CurrentStoryResponse(); // Function StoryFramework.StoryDrivenBlendedLightingZoneComponent.OnRep_CurrentStoryResponse // Final|Native|Private // @ game+0x16adb30
};
...
struct AStoryService : AActor {
	...
	void OnRep_ActiveStories(); // Function StoryFramework.StoryService.OnRep_ActiveStories // Final|Native|Private // @ game+0x37b07d0
};
