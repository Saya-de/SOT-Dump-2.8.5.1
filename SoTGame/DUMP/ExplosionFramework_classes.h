...
struct UFuseInterface : UInterface {
	...
	bool GetIsActive(); // Function ExplosionFramework.FuseInterface.GetIsActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x40b7ac0
};
...
struct UTaleQuestFuseFunctionLibrary : UTaleQuestFunctionStepLibrary {
	...
	void TriggerFuse(struct AActor* InFuseActor); // Function ExplosionFramework.TaleQuestFuseFunctionLibrary.TriggerFuse // Final|Native|Static|Public // @ game+0x40b7af0
};
