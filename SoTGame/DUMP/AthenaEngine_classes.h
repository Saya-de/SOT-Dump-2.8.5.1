...
struct UForceFeedbackCondition : UObject {
	...
	bool CanPlayForceFeedback(struct AActor* InOwner); // Function AthenaEngine.ForceFeedbackCondition.CanPlayForceFeedback // Native|Event|Public|BlueprintEvent|Const // @ game+0x327c510
};
...
struct UBoxedRpcDispatcherComponent : UActorComponent {
	...
	void Server_SendRpc(struct FSerialisedRpc Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.Server_SendRpc // Net|NetReliableNative|Event|Protected|NetServer|NetValidate // @ game+0x327ca10
	void NetMulticastExcludeServer_SendRpc(struct FSerialisedRpc Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.NetMulticastExcludeServer_SendRpc // Net|NetReliableNative|Event|NetMulticast|Protected // @ game+0x327c8e0
	void Client_SendRpc(struct FSerialisedRpc Event); // Function AthenaEngine.BoxedRpcDispatcherComponent.Client_SendRpc // Net|NetReliableNative|Event|Protected|NetClient // @ game+0x327c5f0
};
...
struct UDynamicColourPointLightComponent : UPointLightComponent {
	...
	void DeactivateLight(bool Blend); // Function AthenaEngine.DynamicColourPointLightComponent.DeactivateLight // Final|Native|Public|BlueprintCallable // @ game+0x327c690
	void ActivateLight(bool Blend); // Function AthenaEngine.DynamicColourPointLightComponent.ActivateLight // Final|Native|Public|BlueprintCallable // @ game+0x327c450
};
...
struct UPlayModeHelpers : UBlueprintFunctionLibrary {
	...
	void SetPlayModeVariantOverride(char NewPlayModeVariantOverride); // Function AthenaEngine.PlayModeHelpers.SetPlayModeVariantOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x327cb40
	void SetPlayModeOverride(char NewPlayModeOverride); // Function AthenaEngine.PlayModeHelpers.SetPlayModeOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x327cad0
	char GetPlayModeVariant(struct UObject* WorldContext); // Function AthenaEngine.PlayModeHelpers.GetPlayModeVariant // Final|Native|Static|Public|BlueprintCallable // @ game+0x327c7a0
	char GetPlayMode(struct UObject* WorldContext); // Function AthenaEngine.PlayModeHelpers.GetPlayMode // Final|Native|Static|Public|BlueprintCallable // @ game+0x327c720
	void ClearPlayModeVariantOverride(); // Function AthenaEngine.PlayModeHelpers.ClearPlayModeVariantOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x327c5d0
	void ClearPlayModeOverride(); // Function AthenaEngine.PlayModeHelpers.ClearPlayModeOverride // Final|Native|Static|Public|BlueprintCallable // @ game+0x327c5b0
};
...
struct URotateMeshToActorComponent : UActorComponent {
	...
	void SnapMeshToLookAtActor(); // Function AthenaEngine.RotateMeshToActorComponent.SnapMeshToLookAtActor // Final|Native|Public|BlueprintCallable // @ game+0x327cbe0
	void Initialise(struct UMeshComponent* InMeshToRotate, struct AActor* InActorToRotateTo); // Function AthenaEngine.RotateMeshToActorComponent.Initialise // Final|Native|Public|BlueprintCallable // @ game+0x327c820
};
