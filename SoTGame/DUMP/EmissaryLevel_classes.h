...
struct UEmissaryActiveTableVisualiserComponent : UActorComponent {
	...
	void OnControllerEndPlay(char EndPlayReason); // Function EmissaryLevel.EmissaryActiveTableVisualiserComponent.OnControllerEndPlay // Final|Native|Private // @ game+0x4adf650
};
...
struct UEmissaryParticipantComponent : UActorComponent {
	...
	void OnRep_EmissaryLevel(); // Function EmissaryLevel.EmissaryParticipantComponent.OnRep_EmissaryLevel // Final|Native|Private // @ game+0x4adf780
	void OnRep_AffiliatedCompany(struct FName PreviousId); // Function EmissaryLevel.EmissaryParticipantComponent.OnRep_AffiliatedCompany // Final|Native|Private|HasOutParms // @ game+0x4adf6d0
};
...
struct UEmissaryShipAffiliationTrackerComponent : USceneComponent {
	...
	void OnRep_EmissaryCount(); // Function EmissaryLevel.EmissaryShipAffiliationTrackerComponent.OnRep_EmissaryCount // Final|Native|Private // @ game+0x4adf760
};
...
struct UEmissaryVoyageInlineVoteConsumerBase : UVoteConsumerInlineBase {
	...
	void OnRep_Votes(); // Function EmissaryLevel.EmissaryVoyageInlineVoteConsumerBase.OnRep_Votes // Final|Native|Private // @ game+0x4adf7a0
};

// Class EmissaryLevel.StartEmissaryVoyageInlineVoteConsumer
// Size: 0x338 (Inherited: 0x128)
