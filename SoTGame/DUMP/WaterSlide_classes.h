...
struct AWaterSlide : ARide {
	...
	void SetEntranceCollisionComponent(struct UPrimitiveComponent* InEntranceCollisionComponent); // Function WaterSlide.WaterSlide.SetEntranceCollisionComponent // Final|Native|Protected|BlueprintCallable // @ game+0x4925e60
	void ComponentBeginOverlapCallBack(struct AActor* InOtherActor, struct UPrimitiveComponent* InOtherComp, int32_t InOtherBodyIndex, bool InFromSweep, struct FHitResult InSweepResult); // Function WaterSlide.WaterSlide.ComponentBeginOverlapCallBack // Final|Native|Private|HasOutParms // @ game+0x4925c90
};
...
struct AZipline : ARide {
	...
	struct FVector2D ForwardsAttachDetachOffsets; // 0x700(0x08)
	struct FVector2D BackwardsAttachDetachOffsets; // 0x708(0x08)
	char UnknownData_710[0x30]; // 0x710(0x30)
...
struct AInteractableZipline : AZipline {
	...
	float AttachPointSize; // 0x790(0x04)
	float HoldTime; // 0x794(0x04)
};
