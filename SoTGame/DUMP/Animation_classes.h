...
struct UAnimationDataFunctionLib : UBlueprintFunctionLibrary {
	...
	bool UnwrapAnimDataEntryStruct(struct FAnimDataEntryStructWrapper Wrapper, struct UScriptStruct* DestinationStruct, struct FGenericStruct Value); // Function Animation.AnimationDataFunctionLib.UnwrapAnimDataEntryStruct // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3394880
	struct UAnimationData* MakeAnimationData(struct UClass* Class); // Function Animation.AnimationDataFunctionLib.MakeAnimationData // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x3393710
	struct FAnimDataEntryStructWrapper GetAnimDataEntryStructAsStructWrapper(struct UAnimationData* AnimationDataObject, struct UScriptStruct* TheClass); // Function Animation.AnimationDataFunctionLib.GetAnimDataEntryStructAsStructWrapper // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x3392d80
	void CheckAnimDataClassTypeForDuplicateAnimDataEntryStructs(struct UClass* InClass); // Function Animation.AnimationDataFunctionLib.CheckAnimDataClassTypeForDuplicateAnimDataEntryStructs // Final|Native|Static|Public // @ game+0x33929c0
};
...
struct UAnimationDataStoreAsset : UDataAsset {
	...
	struct UAnimationData* LookupAnimationData(struct UClass* AnimDataId); // Function Animation.AnimationDataStoreAsset.LookupAnimationData // Final|Native|Public|BlueprintCallable // @ game+0x3393680
	struct UClass* GetAnimationDataClass(struct FAnimationDataStoreAssetEntry Entry); // Function Animation.AnimationDataStoreAsset.GetAnimationDataClass // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3392e90
};
...
struct UAnimationDataStoreInterface : UInterface {
	...
	struct UAnimationData* GetAnimationDataForId(struct UClass* AnimDataId); // Function Animation.AnimationDataStoreInterface.GetAnimationDataForId // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x3392f30
};
...
struct UCosmeticItemAnimationInstance : UAnimInstance {
	...
	void UnregisterEvents(); // Function Animation.CosmeticItemAnimationInstance.UnregisterEvents // Final|Native|Private // @ game+0x3394860
};
...
struct UCustomAnimationMontageComponent : UActorComponent {
	...
	void OnRep_ReplicatedData(struct FCustomAnimationMontageComponentReplicatedData PriorData); // Function Animation.CustomAnimationMontageComponent.OnRep_ReplicatedData // Final|Native|Private|HasOutParms // @ game+0x3393910
};
...
struct ULimbIKFunctionLibrary : UBlueprintFunctionLibrary {
	...
	void SetTranslationStrength(struct FLimbIK LimbIK, float InRotationStrength); // Function Animation.LimbIKFunctionLibrary.SetTranslationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x33943a0
	void SetTransform(struct FLimbIK LimbIK, struct FTransform InTransform); // Function Animation.LimbIKFunctionLibrary.SetTransform // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x3394250
	void SetRotationStrength(struct FLimbIK LimbIK, float InRotationStrength); // Function Animation.LimbIKFunctionLibrary.SetRotationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3394150
	void SetParentBone(struct FLimbIK LimbIK, struct FName Bone); // Function Animation.LimbIKFunctionLibrary.SetParentBone // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3394040
	void SetIKSpace(struct FLimbIK LimbIK, char IKSpace); // Function Animation.LimbIKFunctionLibrary.SetIKSpace // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3393f40
	void SetEnabled(struct FLimbIK LimbIK, bool Enabled, char IKSpace, struct FName ParentBone); // Function Animation.LimbIKFunctionLibrary.SetEnabled // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3393db0
	void SetBlendOutSpeed(struct FLimbIK LimbIK, float BlendOutSpeed); // Function Animation.LimbIKFunctionLibrary.SetBlendOutSpeed // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3393cb0
	void SetBlendInSpeed(struct FLimbIK LimbIK, float BlendInSpeed); // Function Animation.LimbIKFunctionLibrary.SetBlendInSpeed // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3393bb0
	void SetAnimationOverride(struct FLimbIK LimbIK, bool AnimationOverride); // Function Animation.LimbIKFunctionLibrary.SetAnimationOverride // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3393ab0
	void SetAlphaTarget(struct FLimbIK LimbIK, float AlphaTarget); // Function Animation.LimbIKFunctionLibrary.SetAlphaTarget // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x33939b0
	bool IsEnabled(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.IsEnabled // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x33935c0
	float GetTranslationStrength(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetTranslationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3393480
	struct FTransform GetTransform(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetTransform // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x33933a0
	float GetRotationStrength(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetRotationStrength // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x33932e0
	struct FName GetParentBone(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetParentBone // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3393210
	char GetIKSpace(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetIKSpace // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3393150
	float GetCurrentAlpha(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetCurrentAlpha // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3393090
	bool GetAnimationOverride(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetAnimationOverride // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3392fd0
	float GetAlphaTarget(struct FLimbIK LimbIK); // Function Animation.LimbIKFunctionLibrary.GetAlphaTarget // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3392cc0
	float ConvertBoolToAlpha(bool InBool); // Function Animation.LimbIKFunctionLibrary.ConvertBoolToAlpha // Final|Native|Static|Public|BlueprintCallable|BlueprintPure // @ game+0x3392a30
};
...
struct ULocomotionFunctionLib : UBlueprintFunctionLibrary {
	...
	float UpdateControllerSpineRotation(struct FRotator CharacterRotation, float AngleSpeedMax, float AngleSpeedMin); // Function Animation.LocomotionFunctionLib.UpdateControllerSpineRotation // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x3394d40
	struct FActorVelocityData UpdateCharacterSpeed(struct FVector Velocity, float CurrentMaxWalkSpeed, float WantedMovementSpeed, float BaseMaxWalkSpeed, float SpeedBlendValue, bool IsSwimming, float DeadZone); // Function Animation.LocomotionFunctionLib.UpdateCharacterSpeed // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x3394b10
	float UpdateCalculateRateAndCurrentYaw(struct FRotator CharacterRotation, float LargeRate, float CurrentCharacterYaw, float DeltaSeconds); // Function Animation.LocomotionFunctionLib.UpdateCalculateRateAndCurrentYaw // Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure // @ game+0x33949b0
};
...
struct UNetworkSyncedAnimationComponent : UActorComponent {
	...
	void OnRep_PlayingAnimationIndex(); // Function Animation.NetworkSyncedAnimationComponent.OnRep_PlayingAnimationIndex // Final|Native|Protected // @ game+0x33938f0
	void OnRep_AnimationProgression(); // Function Animation.NetworkSyncedAnimationComponent.OnRep_AnimationProgression // Final|Native|Protected // @ game+0x33938d0
};
...
struct UTurningFunctionLib : UBlueprintFunctionLibrary {
	...
	bool TurningUpdate(float DeltaSeconds, bool CharacterMoving, bool DeadZone, float TurnRate, float DelayedCounter, float CounterMax, bool TurningLeft); // Function Animation.TurningFunctionLib.TurningUpdate // Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure // @ game+0x3394630
};
...
struct UWaitForAnimationStateEntryProxy : UObject {
	...
	void OnEnteredState(struct FName path); // Function Animation.WaitForAnimationStateEntryProxy.OnEnteredState // Final|Native|Public // @ game+0x33937d0
	void OnAnimationUpdated(); // Function Animation.WaitForAnimationStateEntryProxy.OnAnimationUpdated // Final|Native|Public // @ game+0x3393790
	struct UWaitForAnimationStateEntryProxy* CreateProxy(struct UAnimInstance* AnimInstance, struct FName TargetPath); // Function Animation.WaitForAnimationStateEntryProxy.CreateProxy // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3392af0
};
...
struct UWaitForAnimationStateExitProxy : UObject {
	...
	void OnExitState(struct FName path); // Function Animation.WaitForAnimationStateExitProxy.OnExitState // Final|Native|Public // @ game+0x3393850
	void OnAnimationUpdated(); // Function Animation.WaitForAnimationStateExitProxy.OnAnimationUpdated // Final|Native|Public // @ game+0x33937b0
	struct UWaitForAnimationStateExitProxy* CreateProxy(struct UAnimInstance* AnimInstance, struct FName TargetPath); // Function Animation.WaitForAnimationStateExitProxy.CreateProxy // Final|Native|Static|Public|HasOutParms|BlueprintCallable // @ game+0x3392bc0
};
...
struct UWeightedAnimSequenceLoadOnDemand : UObject {
	...
	void Initialise(struct UWeightedAnimationLoadOnDemandDataAsset* InAnimationData); // Function Animation.WeightedAnimSequenceLoadOnDemand.Initialise // Final|Native|Public|BlueprintCallable // @ game+0x3393540
	struct UWeightedAnimSequenceLoadOnDemand* CreateNewWeightedAnimSequenceLoadOnDemand(); // Function Animation.WeightedAnimSequenceLoadOnDemand.CreateNewWeightedAnimSequenceLoadOnDemand // Final|Native|Static|Public|BlueprintCallable // @ game+0x3392ac0
};
...
struct UDockableInterface : UInterface {
	...
	void HandleDestroy(); // Function Animation.DockableInterface.HandleDestroy // Native|Public // @ game+0x3827d00
	struct FDockableInfo GetDockableInfo(); // Function Animation.DockableInterface.GetDockableInfo // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x3827bd0
};
