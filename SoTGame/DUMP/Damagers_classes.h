...
struct URadialDamagerComponent : UActorComponent {
	...
	void SetDamageRadius(float Radius); // Function Damagers.RadialDamagerComponent.SetDamageRadius // Final|Native|Public|BlueprintCallable // @ game+0x49430a0
	void EndDamage(); // Function Damagers.RadialDamagerComponent.EndDamage // Final|Native|Public|BlueprintCallable // @ game+0x4942f10
	void BeginDamage(); // Function Damagers.RadialDamagerComponent.BeginDamage // Final|Native|Public|BlueprintCallable // @ game+0x4942ef0
};
...
struct UShockwaveDamagerInterface : UInterface {
	...
	void StartShockwaveAtLocation(struct FVector StartLocation); // Function Damagers.ShockwaveDamagerInterface.StartShockwaveAtLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4943140
	void StartShockwave(); // Function Damagers.ShockwaveDamagerInterface.StartShockwave // Native|Public|BlueprintCallable // @ game+0x4943120
	void IgnoreGhostShip(struct AAggressiveGhostShip* Ship); // Function Damagers.ShockwaveDamagerInterface.IgnoreGhostShip // Native|Public|BlueprintCallable // @ game+0x4942f90
	float GetShockwaveRadius(); // Function Damagers.ShockwaveDamagerInterface.GetShockwaveRadius // Native|Public|BlueprintCallable // @ game+0x4942f60
	float GetShockwaveDuration(); // Function Damagers.ShockwaveDamagerInterface.GetShockwaveDuration // Native|Public|BlueprintCallable // @ game+0x4942f30
};
...
struct UShockwaveDamagerComponent : UActorComponent {
	...
	void Multi_StartShockwave(struct FVector InStartLocation); // Function Damagers.ShockwaveDamagerComponent.Multi_StartShockwave // Final|Net|NetReliableNative|Event|NetMulticast|Private|HasDefaults // @ game+0x4943020
};
...
struct UShipDamagerComponent : UActorComponent {
	...
	void SetShape(struct UPrimitiveComponent* InShape); // Function Damagers.ShipDamagerComponent.SetShape // Final|Native|Public|BlueprintCallable // @ game+0x4b4e0d0
	void EndDamage(); // Function Damagers.ShipDamagerComponent.EndDamage // Final|Native|Public|BlueprintCallable // @ game+0x4b4ddf0
	void BeginDamage(); // Function Damagers.ShipDamagerComponent.BeginDamage // Final|Native|Public|BlueprintCallable // @ game+0x4b4ddd0
};
