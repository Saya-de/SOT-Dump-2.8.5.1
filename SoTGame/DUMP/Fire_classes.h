...
struct UFlammableComponent : UActorComponent {
	...
	void OnRep_OnFire(); // Function Fire.FlammableComponent.OnRep_OnFire // Final|Native|Protected // @ game+0x396cce0
	void Multicast_NotifyExtinguished_RPC(struct FVector InExtinguishLocationWS); // Function Fire.FlammableComponent.Multicast_NotifyExtinguished_RPC // Net|Native|Event|NetMulticast|Protected|HasDefaults // @ game+0x396cc60
	bool IsOnFire(); // Function Fire.FlammableComponent.IsOnFire // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x396cc20
	void IncrementFireSource(); // Function Fire.FlammableComponent.IncrementFireSource // Native|Public|BlueprintCallable // @ game+0x396cbf0
	void DecrementFireSource(); // Function Fire.FlammableComponent.DecrementFireSource // Native|Public|BlueprintCallable // @ game+0x396cba0
};
...
struct UFlammableInterface : UInterface {
	...
	void IncrementFireSource(); // Function Fire.FlammableInterface.IncrementFireSource // Native|Public|BlueprintCallable // @ game+0x396cbd0
	void DecrementFireSource(); // Function Fire.FlammableInterface.DecrementFireSource // Native|Public|BlueprintCallable // @ game+0x396cb80
};
...
struct UFirePropagationInterface : UInterface {
	...
	void SetAllCellsState(char State); // Function Fire.FirePropagationInterface.SetAllCellsState // BlueprintAuthorityOnly|Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x4075970
};
...
struct UShipFirePropagationComponent : UActorComponent {
	...
	void OnRep_CellData(); // Function Fire.ShipFirePropagationComponent.OnRep_CellData // Final|Native|Private // @ game+0x4075950
	void OnRep_CellCharringData(); // Function Fire.ShipFirePropagationComponent.OnRep_CellCharringData // Final|Native|Private // @ game+0x4075930
};
