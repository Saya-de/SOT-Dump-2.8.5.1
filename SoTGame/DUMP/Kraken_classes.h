...
struct AKrakenTentacle : AActor {
	...
	void OnDamageToTentacle(struct FImpactDamageEvent ImpactDamageEvent); // Function Kraken.KrakenTentacle.OnDamageToTentacle // Final|Native|Public|HasOutParms // @ game+0x4b3e080
};
...
struct AMurk : AActor {
	...
	void DeactivateMurkBP(); // Function Kraken.Murk.DeactivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x4b3de60
	void ActivateMurkBP(); // Function Kraken.Murk.ActivateMurkBP // Final|Native|Public|BlueprintCallable // @ game+0x4b3ddc0
};
...
struct AKrakenShipWrappingTentacle : AKrakenTentacle {
	...
	void OnRep_CurrentServerAnimationState(); // Function Kraken.KrakenShipWrappingTentacle.OnRep_CurrentServerAnimationState // Final|Native|Private // @ game+0x4b3e180
};
...
struct AKraken : AActor {
	...
	void Multicast_OnTentacleTakenDamage(); // Function Kraken.Kraken.Multicast_OnTentacleTakenDamage // Final|Net|Native|Event|NetMulticast|Private // @ game+0x4b3dfe0
	void AddActorToKnownTargets(struct AActor* Target); // Function Kraken.Kraken.AddActorToKnownTargets // Final|Native|Public|BlueprintCallable // @ game+0x4b3dde0
};
...
struct AKrakenHead : AActor {
	...
	void TestSetDamageEnabled(bool InEnabled); // Function Kraken.KrakenHead.TestSetDamageEnabled // Final|Native|Public|BlueprintCallable // @ game+0x4b3e390
	void RequestState(struct UClass* NewState); // Function Kraken.KrakenHead.RequestState // Native|Public|HasOutParms|BlueprintCallable // @ game+0x4b3e2f0
	void OnRep_IsDamageEnabled(); // Function Kraken.KrakenHead.OnRep_IsDamageEnabled // Final|Native|Protected // @ game+0x4b3e1c0
	void OnRep_HeadStateRequest(); // Function Kraken.KrakenHead.OnRep_HeadStateRequest // Final|Native|Protected // @ game+0x4b3e1a0
	void OnCoordinatedKrakenSpecialEvent(char InEventType); // Function Kraken.KrakenHead.OnCoordinatedKrakenSpecialEvent // Final|Native|Private // @ game+0x4b3e000
};
...
struct AKrakenService : AActor {
	...
	void Test_TrySpawningKraken(); // Function Kraken.KrakenService.Test_TrySpawningKraken // Final|Native|Public|BlueprintCallable // @ game+0x4b3e470
	bool Test_IsCurrentStateInactive(); // Function Kraken.KrakenService.Test_IsCurrentStateInactive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4b3e440
	bool Test_IsCurrentStateActive(); // Function Kraken.KrakenService.Test_IsCurrentStateActive // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4b3e410
	void RequestKrakenWithLocation(struct FVector SpawnLocation, struct AActor* SpawnedForActor, bool IsRequestedOnDemand); // Function Kraken.KrakenService.RequestKrakenWithLocation // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4b3e1e0
	bool IsServiceInitialized(); // Function Kraken.KrakenService.IsServiceInitialized // Final|Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4b3dfb0
	bool IsKrakenActive(); // Function Kraken.KrakenService.IsKrakenActive // Native|Public|BlueprintCallable|BlueprintPure|Const // @ game+0x4b3df70
	bool DismissOrRemoveCrewFromKraken(struct FGuid InCrewId); // Function Kraken.KrakenService.DismissOrRemoveCrewFromKraken // Native|Public|HasOutParms|HasDefaults|BlueprintCallable // @ game+0x4b3dec0
	bool DismissKraken(); // Function Kraken.KrakenService.DismissKraken // Native|Public|BlueprintCallable // @ game+0x4b3de80
};
