...
struct FSpawnAICustomPreSpawnTaskData {
	...
	struct FRotator SpawnRotation; // 0x10(0x0c)
	bool PerceiveActor; // 0x1c(0x01)
	char UnknownData_1D[0x3]; // 0x1d(0x03)
	struct UClass* PawnClass; // 0x20(0x20)
	struct UAthenaAIControllerParamsDataAsset* Skillset; // 0x40(0x08)
	struct ULoadoutAsset* Loadout; // 0x48(0x08)
	struct UAthenaAIFormDataAsset* Form; // 0x50(0x08)
	struct UAthenaAIAmmoDataAsset* Ammo; // 0x58(0x08)
	struct UClass* AIClass; // 0x60(0x08)
	struct UAIPartsCategory* PartsCategory; // 0x68(0x08)
	struct UTaleQuestStepDesc* Body; // 0x70(0x08)
};
