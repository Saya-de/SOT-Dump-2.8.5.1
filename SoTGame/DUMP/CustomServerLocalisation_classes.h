...
struct ACustomServerLocalisationService : AActor {
	...
	void OnRep_GenerateLocalisationData(); // Function CustomServerLocalisation.CustomServerLocalisationService.OnRep_GenerateLocalisationData // Final|Native|Private // @ game+0x42e90c0
	void BeginPlay(); // Function CustomServerLocalisation.CustomServerLocalisationService.BeginPlay // Final|Native|Private // @ game+0x42e90a0
};
