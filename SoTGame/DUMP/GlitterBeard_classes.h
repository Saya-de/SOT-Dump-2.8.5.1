...
struct UGlitterBeardFinaleCoordinatorComponent : UActorComponent {
	...
	void OnRep_ReplicationState(struct FFinaleReplicationState OldState); // Function GlitterBeard.GlitterBeardFinaleCoordinatorComponent.OnRep_ReplicationState // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x4418450
};
...
struct AGlitterBeardTree : AActor {
	...
	void StopVocals(); // Function GlitterBeard.GlitterBeardTree.StopVocals // Final|Native|Public|BlueprintCallable // @ game+0x4418590
	bool StopReaction(); // Function GlitterBeard.GlitterBeardTree.StopReaction // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x4418550
	void StartVocals(); // Function GlitterBeard.GlitterBeardTree.StartVocals // Final|Native|Public|BlueprintCallable // @ game+0x4418530
	bool StartReaction(); // Function GlitterBeard.GlitterBeardTree.StartReaction // Native|Event|Public|BlueprintCallable|BlueprintEvent // @ game+0x44184f0
	void Reset_Impl(); // Function GlitterBeard.GlitterBeardTree.Reset_Impl // Event|Protected|BlueprintEvent // @ game+0x188c2f0
};
...
struct UGlitterBeardTreeVisualFeedbackComponent : UActorComponent {
	...
	void OnRep_NextStateEvent(struct TArray<char> OldStates); // Function GlitterBeard.GlitterBeardTreeVisualFeedbackComponent.OnRep_NextStateEvent // Final|RequiredAPI|Native|Private|HasOutParms // @ game+0x44183a0
};
